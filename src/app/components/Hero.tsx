    ...
    <section className="relative h-screen flex items-center justify-center text-white overflow-hidden py-28 scroll-mt-24">
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <p className="mt-6 max-w-xl mx-auto text-zinc-400 leading-relaxed text-sm sm:text-base">
          I design and build real-time applications, distributed systems, and
          high-performance APIs using Node.js and modern data architectures.
        </p>

        <p className="mt-3 text-xs text-zinc-500">
          Focus: Real-time systems • Distributed processing • Backend
          architecture
        </p>
        ...
        <div className="mt-10 flex justify-center gap-4">
          <button
            ...
            className="px-6 py-3 rounded-lg bg-indigo-500
