  ...
  return (
    <div className="p-6 flex flex-col justify-around rounded-xl border border-zinc-800 bg-zinc-900/40 hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
      ...
      <div className="mt-4 flex items-center gap-3 text-xs">
        <a href={project.links.github} className="bg-zinc-900 p-2 border rounded-md border-zinc-700 flex items-center justify-center hover:border-zinc-400 ">
          <svg
            viewBox="0 0 24 24"
        ...
        <a href={project.links.caseStudy} className="hover:text-indigo-400">
          Details →
        </a>
      </div>
    </div>
